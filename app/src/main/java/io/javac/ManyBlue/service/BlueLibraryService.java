    ...
    public void onMessageEvent(NotifyMessage notifyMessage) {
        ...
        switch (notifyMessage.getCode()) {
            ...
            case CodeUtils.SERVICE_DEVICE_CONN://连接某一个设备  并且主动发现服务
            {
                ...
                BlueGattCallBack blueGattCallBack = null;
//                if(BluetoothGattManager.gattMap.containsKey(notifyMessage.getTag())){
//                    blueGattCallBack = BluetoothGattManager.getGatt(notifyMessage.getTag());
//                    blueGattCallBack.getGatt().close();
//                }
                blueGattCallBack = new BlueGattCallBack();
...
//            break;
            case CodeUtils.SERVICE_DISCONN_DEVICE://断开指定连接
            {
                ...
                if(gatt != null)
                   gatt.disconnect();
                BluetoothGattManager.removeGatt(notifyMessage.getTag());
            }
            break;
