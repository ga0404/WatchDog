...
public class ProgressDialog {
    ...
    public ProgressDialog show(int timeout) {
        ...
        dialog = new AlertDialog.Builder(act, R.style.loading_dialog_style).setCancelable(cancelable).create();
    ...
    public void cancel() {
        if (null != m_cb && !m_cb.onCancel()) return;
        if (null != m_thread) m_thread.interrupt();
        m_isTimeout = false;
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            //Toast.makeText(Gloal.m_ctx, m_self.m_timeoutToast, Toast.LENGTH_SHORT).show();
        }
    }
