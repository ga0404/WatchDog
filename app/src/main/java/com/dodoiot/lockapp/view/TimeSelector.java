...
import com.dodoiot.lockapp.util.ScreenUtil;
...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate,String formate) {
        this.context = context;
        this.handler = resultHandler;
        this.FORMAT_STR = formate;
        startCalendar = Calendar.getInstance();
        endCalendar = Calendar.getInstance();
        //Log.e("dfc",startDate+"<----------->"+(FORMAT_STR == null));
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime,String formate) {
        this(context, resultHandler, startDate, endDate,formate);
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            seletorDialog = new Dialog(context, R.style.time_dialog1);
